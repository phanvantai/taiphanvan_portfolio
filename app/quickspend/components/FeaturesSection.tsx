    ...
    return (
        <section id="features" className="features-section">
            <div className="container">
                ...
                {renderFeatureGrid(t.features.inputFeatures.title, t.features.inputFeatures.items)}
                {renderFeatureGrid(t.features.analyticsFeatures.title, t.features.analyticsFeatures.items)}
            </div>
        </section>
    )
}
